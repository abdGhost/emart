            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: List.generate(
                  6,
                  (index) => 'Men Clothing'.text.fontFamily(semibold).color(darkFontGrey).makeCentered().box.white.rounded.size(150, 60).margin(const EdgeInsets.symmetric(horizontal: 4)).make(),
                ),
              ),
            ),
            20.heightBox,
            Expanded(
              ...
              itemBuilder: (context, index) {
                return Column(
                  ...
                  Get.to(() => const ItemDetailsScreen(titile: 'Dummy Title'));
                });
              },
            ))
          ],
